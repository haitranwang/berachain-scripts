...
const croc_1 = require("@crocswap-libs/sdk/dist/croc");
...
function demo() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        // croc.pool(USDC, '0x0000000000000000000000000000000000000000').displayPrice().then(console.log);
        // croc.pool('0x0000000000000000000000000000000000000000', USDC).displayPrice().then(console.log);

        croc.pool('0x0000000000000000000000000000000000000000', USDC).mintAmbientQuote(100, [2000, 4000])
