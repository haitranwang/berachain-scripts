...
function addMintable(c, access) {
    ...
    (0, set_access_control_1.requireAccessControl)(c, functions.mintBatch, access, 'MINTER', 'minter');
...
function addSetUri(c, access) {
    (0, set_access_control_1.requireAccessControl)(c, functions.setURI, access, 'URI_SETTER', undefined);
