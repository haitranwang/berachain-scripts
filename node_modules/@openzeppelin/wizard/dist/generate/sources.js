...
function generateContractSubset(subset, kind) {
    const contracts = [];
...
function* generateSources(subset, kind) {
...
async function writeGeneratedSources(dir, subset, kind) {
