...
function addURIStorage(c) {
    ...
    c.addOverride(ERC721URIStorage, common_functions_1.supportsInterface);
}
...
function addMintable(c, access, incremental = false, uriStorage = false) {
    ...
    (0, set_access_control_1.requireAccessControl)(c, fn, access, 'MINTER', 'minter');
    if (incremental) {
...
function addVotes(c, name, clockMode) {
    const EIP712 = {
        name: 'EIP712',
    ...
    (0, set_clock_mode_1.setClockMode)(c, ERC721Votes, clockMode);
}
